...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "vc-page-panel text-card-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "font-display text-[1.75rem] font-semibold leading-tight tracking-[-0.03em] text-[#0f241a]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-sm leading-7 text-[rgba(29,47,38,0.68)]", className)}
    {...props}
  />
))
